...
<script type="text/javascript" >
	function addCheckForm() {
	    ...
	    var input_score= document.getElementById('addmynumber').value;
  ...
  <table id="items" >
	...
	<div id="add_comm" class="all" align="left">
	  ...
	  <h2 id="edit_title">添加学员</h2>
		...
		<input id="addmynumber" type="text" placeholder="号码" name="mynumber" />
		<input id="address" type="text" placeholder="住所" name="address" />
